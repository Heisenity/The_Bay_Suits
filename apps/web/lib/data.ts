...
export const properties: Property[] = [
  ...
  {
    id: "vancouver",
    slug: "coal-harbour-glasshouse",
    name: "Coal Harbour Glasshouse",
    ...
    description:
      "Created for executive travel and design-minded vacations, this Vancouver residence balances calming interiors, premium bedding and quick access to the seawall, convention centre and central business district.",
    price: 309,
    bedrooms: 2,
    bathrooms: 2,
    guests: 4,
    ...
    amenities: ["Harbour views", "Concierge", "Gym", "Workspace", "EV parking"],
    featured: true
  },
  {
    id: "montreal",
    slug: "old-port-loft-suite",
    name: "Old Port Loft Suite",
    ...
    description:
      "A beautifully updated loft residence that pairs heritage textures with contemporary comfort. Guests have generous living space, a full kitchen and simple access to restaurants, galleries and business meetings downtown.",
    price: 244,
    bedrooms: 1,
    bathrooms: 1,
    guests: 3,
  ...
  {
    id: "calgary",
    slug: "beltline-reserve",
    name: "Beltline Reserve",
    location: "Beltline, Calgary",
    area: "Calgary",
    shortDescription: "A refined downtown Calgary suite for relocations, projects and long weekends.",
    description:
      "Warm, understated finishes and a practical layout make this Beltline home ideal for both productive and relaxed stays. It includes a quiet workspace, private balcony and simple access to restaurants and river pathways.",
    price: 196,
    bedrooms: 2,
    bathrooms: 2,
    guests: 4,
  ...
  {
    id: "ottawa",
    slug: "byward-market-flat",
    name: "ByWard Market Flat",
    location: "ByWard Market, Ottawa",
    area: "Ottawa",
    shortDescription: "A city-centre residence near Parliament, dining and cultural landmarks.",
    description:
      "Comfortable and quietly sophisticated, this Ottawa stay offers an easy base for government travel, family visits and extended city living with thoughtful hospitality built in.",
    price: 208,
    bedrooms: 1,
    bathrooms: 1,
    guests: 2,
  ...
  {
    id: "halifax",
    slug: "halifax-waterfront-residence",
    name: "Halifax Waterfront Residence",
    location: "Waterfront, Halifax",
    area: "Halifax",
    shortDescription: "An airy coastal city stay with harbour access and a calm residential feel.",
    description:
      "Designed for guests who want both convenience and quiet, this Halifax apartment offers bright interiors, easy waterfront access and dependable support for shorter or extended stays.",
    price: 184,
    bedrooms: 1,
    bathrooms: 1,
    guests: 2,
  ...
  {
    id: "edmonton",
    slug: "ice-district-stay",
    name: "Ice District Stay",
    location: "Downtown, Edmonton",
    area: "Edmonton",
    shortDescription: "A contemporary downtown residence close to the arena, offices and dining.",
    description:
      "A smartly arranged city home for project teams, medical stays and weekend events. Expect a complete kitchen, dependable Wi-Fi and a welcoming arrival experience.",
    price: 172,
    bedrooms: 1,
    bathrooms: 1,
    guests: 2,
  ...
  },
  {
    ...
    description:
      "A crisp, elevated Miami residence built for stylish city stays. Guests enjoy pool access, a polished living area, full kitchen amenities and quick movement between meetings and waterfront evenings.",
    price: 332,
    bedrooms: 2,
    bathrooms: 2,
    guests: 4,
    ...
    amenities: ["Pool", "Bay views", "Valet access", "Gym", "Concierge"],
    featured: true
  },
  {
    id: "kolkata",
    slug: "eco-park-signature-suite",
    name: "Eco Park Signature Suite",
    location: "New Town, Kolkata",
    area: "Kolkata",
    shortDescription: "A polished East Kolkata stay near the tech corridor and lifestyle district.",
    description:
      "Prepared for corporate travelers, family visits and relocation stays, this Kolkata residence offers a calm palette, full kitchen setup, work-friendly layout and proximity to the city's business spine.",
    price: 128,
    bedrooms: 2,
    bathrooms: 2,
    guests: 4,
    ...
    amenities: ["Wi-Fi", "Gated access", "Housekeeping coordination", "Workspace", "Airport access"],
    featured: true
  },
  {
    id: "bangalore",
    slug: "indiranagar-garden-suite",
    name: "Indiranagar Garden Suite",
    location: "Indiranagar, Bangalore",
    area: "Bangalore",
    shortDescription: "A calm design-led stay in one of Bangalore's most connected neighbourhoods.",
    description:
      "This Bangalore apartment is tuned for longer productive stays, with a dedicated work zone, strong connectivity, full kitchen serviceability and easy access to the city's startup and corporate hubs.",
    price: 136,
    bedrooms: 2,
    bathrooms: 2,
    guests: 4,
  ...
  {
    id: "delhi",
    slug: "aerocity-premier-residence",
    name: "Aerocity Premier Residence",
    location: "Aerocity, Delhi",
    area: "Delhi",
    shortDescription: "A sleek airport-corridor home suited to business travel and stopover stays.",
    description:
      "Minutes from the airport and business hotels, this Delhi residence offers premium convenience with a quieter residential rhythm, polished interiors and flexible stay comfort.",
    price: 148,
    bedrooms: 1,
    bathrooms: 1,
    guests: 2,
